...
# MAGIC - [Micro-batch Size](https://learn.microsoft.com/en-us/azure/databricks/structured-streaming/batch-size)
# MAGIC - [Watermarks](https://learn.microsoft.com/en-us/azure/databricks/structured-streaming/watermarks)
...
# MAGIC - [Trigger Intervals](https://learn.microsoft.com/en-us/azure/databricks/structured-streaming/triggers)
# MAGIC - [Delta table streaming reads and writes](https://learn.microsoft.com/en-us/azure/databricks/structured-streaming/delta-lake)