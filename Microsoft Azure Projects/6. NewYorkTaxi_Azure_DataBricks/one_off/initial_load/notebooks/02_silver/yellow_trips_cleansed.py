...
# In this example I expect the tpep_pickup_datetime to be within January 2025 and October 2025 as these are the parquet files I initially loaded
df = df.filter("tpep_pickup_datetime >= '2025-01-01' AND tpep_pickup_datetime < '2025-10-01'")
